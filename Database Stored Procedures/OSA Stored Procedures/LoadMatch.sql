...
/****** Object:  StoredProcedure [dbo].[LoadMatch]    Script Date: 03/12/2016 15:20:54 ******/
...
--exec [LoadScorecardAndMatch] 'http://stats.espncricinfo.com/ci/engine/match/760785.html'

CREATE proc [dbo].[LoadMatch]
...
delete from Match where Url = @Url
