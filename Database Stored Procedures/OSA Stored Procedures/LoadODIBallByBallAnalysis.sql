...
/****** Object:  StoredProcedure [dbo].[LoadODIBallByBallAnalysis]    Script Date: 03/12/2016 15:20:58 ******/
DROP PROCEDURE [dbo].[LoadODIBallByBallAnalysis]
GO
...
CREATE proc [dbo].[LoadODIBallByBallAnalysis] 
...
, Commentary =
	rtrim(replace(replace(replace( 
		replace(replace(TidyCommentary,',',', '),',  ',', ')
