...
/****** Object:  StoredProcedure [dbo].[LoadODIEndOfOverAnalysis]    Script Date: 03/12/2016 15:21:06 ******/
DROP PROCEDURE [dbo].[LoadODIEndOfOverAnalysis]
GO
...
CREATE Proc [dbo].[LoadODIEndOfOverAnalysis] 

@Url varchar(800)

as

delete from ODIEndOfOverAnalysis where Url = @Url;
...
insert into ODIEndOfOverAnalysis
select
rownum,
@Url,
