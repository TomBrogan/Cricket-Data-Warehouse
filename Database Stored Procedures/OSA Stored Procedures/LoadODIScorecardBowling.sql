...
/****** Object:  StoredProcedure [dbo].[LoadODIScorecardBowling]    Script Date: 03/12/2016 15:23:05 ******/
DROP PROCEDURE [dbo].[LoadODIScorecardBowling]
GO
...
CREATE proc [dbo].[LoadODIScorecardBowling] 
...
delete from ODIScorecardBowling where Url = @Url

insert into ODIScorecardBowling
select
@Url as Url,
i.InningsNumber,
