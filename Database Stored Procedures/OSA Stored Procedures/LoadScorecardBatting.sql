...
/****** Object:  StoredProcedure [dbo].[LoadScorecardBatting]    Script Date: 03/12/2016 15:29:51 ******/
DROP PROCEDURE [dbo].[LoadScorecardBatting]
GO
...
CREATE proc [dbo].[LoadScorecardBatting]
...
delete from Scorecard where Url = @Url
